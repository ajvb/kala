...
func TestBrokenDelayHandling(t *testing.T) {
	...
	for _, intervalTest := range brokenIntervals {
		...
		err := genericMockJob.Init(cache, nil)
...
func TestDependentJobsParentDoesNotExist(t *testing.T) {
	...
	err := mockChildJob.Init(cache, nil)
	assert.Error(t, err)
...
func TestDependentJobsTwoChilds(t *testing.T) {
	...
	mockChildJobOne.Init(cache, nil)
	...
	mockChildJobTwo.Init(cache, nil)
...
func TestDependentJobsFiveChain(t *testing.T) {
	...
	mockChildJobThree.Init(cache, nil)
	...
	mockChildJobFour.Init(cache, nil)
	...
	mockChildJobFive.Init(cache, nil)
...
func TestDependentJobsParentJobGetsDeleted(t *testing.T) {
	...
	mockChildJobWithBackup.Init(cache, nil)
