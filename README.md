...
[![Circle CI](https://circleci.com/gh/cescoferraro/kala.svg?style=svg)](https://circleci.com/gh/cescoferraro/kala)
[![Coverage Status](https://coveralls.io/repos/cescoferraro/kala/badge.svg?branch=master&service=github)](https://coveralls.io/github/cescoferraro/kala?branch=master)

#### Donate

[![Flattr this git repo](http://api.flattr.com/button/flattr-badge-large.png)](https://flattr.com/submit/auto?user_id=cescoferraro&url=https://github.com/cescoferraro/kala&title=Kala&language=&tags=github&category=software)
...
Please create an issue within Github, or also feel free to email me at aj <at> cescoferraro.me
...
1. Get Kala
	...
	```
	go get github.com/cescoferraro/kala
	```
...
1. Change directory to Kala source
	...
	```
	cd $GOPATH/src/github.com/cescoferraro/kala
	```
...
There are more examples in the [examples directory](https://github.com/cescoferraro/kala/tree/master/examples) within this repo. Currently its pretty messy. Feel free to submit a new example if you have one.
...
#### Official:
* Go - [client](https://github.com/cescoferraro/kala/tree/master/client) - Docs: http://godoc.org/github.com/cescoferraro/kala/client

Install using:
`go get github.com/cescoferraro/kala/client`

## Job Data Struct

[Docs can be found here](http://godoc.org/github.com/cescoferraro/kala/job#Job)
...
```
{
        ...
        "command":"bash /home/cescoferraro/gocode/src/github.com/cescoferraro/kala/examples/example-kala-commands/example-command.sh",
        "owner":"",
        "disabled":false,
        "dependent_jobs":null,
        "parent_jobs":null,
...
{"jobs":{}}
$ curl http://127.0.0.1:8000/api/v1/job/ -d '{"epsilon": "PT5S", "command": "bash /home/cescoferraro/gocode/src/github.com/cescoferraro/kala/examples/example-kala-commands/example-command.sh", "name": "test_job", "schedule": "R2/2015-06-04T19:25:16.828696-07:00/PT10S"}'
{"id":"93b65499-b211-49ce-57e0-19e735cc5abd"}
$ curl http://127.0.0.1:8000/api/v1/job/
{
    "jobs":{
...
[Contributor Documentation can be found here](http://godoc.org/github.com/cescoferraro/kala)
...
Check out this [example for how to add dependent jobs](https://github.com/cescoferraro/kala/blob/master/examples/example_dependent_jobs.py) within a python script.
...
* AJ Bahnken / [@cescoferraroahnken](http://twitter.com/cescoferraroahnken) / aj@cescoferraro.me
